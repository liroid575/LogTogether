...
export const EXERCISES: ExerciseDefinition[] = [
  ...
  { id: "jump_rope_basic", names: { en: "Jump Rope — Basic Bounce", "zh-TW": "跳繩－基本跳" }, type: "duration", category: "cardio", group: "home_functional" },
  { id: "jump_rope_single_unders", names: { en: "Jump Rope — Single Unders", "zh-TW": "跳繩－單迴旋" }, type: "reps", category: "cardio", group: "gym" },
  { id: "jump_rope_double_unders", names: { en: "Jump Rope — Double Unders", "zh-TW": "跳繩－雙迴旋" }, type: "reps", category: "cardio", group: "gym" },
